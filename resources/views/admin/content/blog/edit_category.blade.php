...
@section('content')
            ...
            <div class="card-body">
              <form method="POST" preloader-ajax-form=".card" class="ajax-form custom-form">
                ...
                <div class="form-group has-validation">
                  ...
                  <input class="form-control" type="text" id="title-input" name="title"  autocomplete="off" required value="{{ $category->title }}">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" id="alias-input" name="alias" data-url_category="{{ route('blog.postsByCategory', ['alias' => '%alias%']) }}" autocomplete="off" required value="{{ $category->alias }}">
  ...
  {{ HTML::script('admin/js/content/blog/edit_category.js') }}
