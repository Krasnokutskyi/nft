...
@section('content')
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="{{ route('admin.video.createCategory') }}" class="btn btn-sm btn-neutral">Create category</a>
            </div>
          </div>
        </div>
      </div>
                      ...
                      <td class="text-right">
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                            <a class="dropdown-item" href="{{ route('videos.postsByCategory', ['alias' => $category->alias]) }}">Show</a>
                            <a class="dropdown-item" href="{{ route('admin.video.updateCategory', ['category_id' => $category->id]) }}">Edit</a>
                            <a class="dropdown-item" href="{{ route('admin.video.deleteCategoryAction', ['category_id' => $category->id]) }}"  onclick="remove_category(this)">Delete</a>
                          </div>
                        </div>
                      </td>
                    </tr>
  ...
  {{ HTML::script('admin/js/content/video/categories.js') }}
