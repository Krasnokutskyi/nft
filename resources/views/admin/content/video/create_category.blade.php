...
@section('content')
            ...
            <div class="card-body">
              <form method="POST" preloader-ajax-form=".card" class="ajax-form custom-form">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" id="alias-input" name="alias" data-url_category="{{ route('videos.postsByCategory', ['alias' => '%alias%']) }}" autocomplete="off" required>
  ...
  {{ HTML::script('admin/js/content/video/create_category.js') }}
