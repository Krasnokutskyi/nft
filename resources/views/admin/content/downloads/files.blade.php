                      ...
                      <td class="text-right">
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                            <a class="dropdown-item" href="{{ route('admin.storage.content.downloads.file', ['file' => $file->file]) }}" download="{{ $file->title . '.' . pathinfo(route('admin.storage.content.downloads.file', ['file' => $file->file]), PATHINFO_EXTENSION) }}" onclick="downloadFile(event, this)">Download</a>
