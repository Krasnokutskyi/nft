                        ...
                        <div class="row row_box">
                            <div class="downloads__box-item">
                                ...
                                <div class="downloads__box-other">
                                    <span class="downloads__box-pres">{{ $file->type->first()->title }}</span>
                                    <span class="downloads__box-size">{{ str_replace('.', ',', round((Storage::disk('content')->size('downloads/files/' . $file->file)/1048576), 1)) }} MB</span>
                                    <a  href="{{ route('storage.content.downloads.file', ['file' => $file->file]) }}" onclick="downloadFile(event, this)" class="downloads__box-button" download="{{ $file->title . '.' . pathinfo(route('storage.content.downloads.file', ['file' => $file->file]), PATHINFO_EXTENSION) }}">
